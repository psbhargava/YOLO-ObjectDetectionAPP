...
public class YoloV4Classifier implements Classifier {
    ...
    public static YoloV4Classifier create(
    ...
    public static int yolov4_getInputSize() {
        return interpreter.getInputTensor(0).shape()[1];
    }

    public int yolov4_getOutputSize() {
...
//        if (tfLite != null) tfLite.setUseNNAPI(isChecked);
    ...
    // config yolov4
    private static int OUTPUT_WIDTH; // int[]{2535, 2535}; // int[]{10647, 10647};
    ...
    protected ByteBuffer convertBitmapToByteBuffer(Bitmap bitmap) {
        INPUT_SIZE = yolov4_getInputSize();
    ...
    private ArrayList<Recognition> getDetections(ByteBuffer byteBuffer, Bitmap bitmap) {
        OUTPUT_WIDTH = yolov4_getOutputSize();
