...
import org.tensorflow.lite.examples.detection.YOLOV5DetectorActivity;
...
public class YoloV5Classifier implements Classifier {
    ...
    public static YoloV5Classifier create(
        ...
        inputSize = yolov5_getInputSize();
        System.out.println("Hello, inputSize :" + inputSize);
    ...
    public static int yolov5_getInputSize() {
